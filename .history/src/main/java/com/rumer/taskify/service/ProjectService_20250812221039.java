...
public Project shareProject(Long projectId, String userName, User currentUser) {
    ...
    boolean isCollaborator = project.getCollaborators() != null && project.getCollaborators().contains(currentUser);

    if (!isOwner && !isCollaborator) {
        throw new AccessDeniedException("Paylaşım yapma yetkiniz yok.");
    }
