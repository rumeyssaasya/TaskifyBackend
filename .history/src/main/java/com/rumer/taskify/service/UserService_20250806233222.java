    ...
    public User createUser(String username, String password, String email, String fullName, String gender) {
        ...
        if (user.getProfileImageUrl() == null || user.getProfileImageUrl().isEmpty()) {
            switch (gender.toUpperCase()) {
                case "MALE":
                    user.setProfileImageUrl("https://localhost:8080/images/default_male.png");
                    break;
                case "FEMALE":
                    user.setProfileImageUrl("https://localhost:8080/images/default_female.png");
                    break;
                default:
                    user.setProfileImageUrl("https://localhost:8080/images/default_generic.png");
                    break;
            }
        }
