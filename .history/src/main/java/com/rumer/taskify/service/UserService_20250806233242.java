    ...
    public User createUser(String username, String password, String email, String fullName, String gender) {
        ...
        if (user.getProfileImageUrl() == null || user.getProfileImageUrl().isEmpty()) {
            switch (gender.toUpperCase()) {
                case "MALE":
                    user.setProfileImageUrl("https://localhost:8080/images/maleIcon.png");
                    break;
                case "FEMALE":
                    user.setProfileImageUrl("https://localhost:8080/images/femaleIcon.png");
                    break;
                default:
                    user.setProfileImageUrl("https://localhost:8080/images/defaultIcon.png");
                    break;
            }
        }
