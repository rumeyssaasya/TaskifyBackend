...
@Data
@ToString(exclude = {"user", "tasks", "collaborators"})
@EqualsAndHashCode(exclude = {"user", "tasks", "collaborators"})
@Entity
public class Project {
    ...
    @JsonIgnore // Bu anotasyon, JSON serileştirmede döngüsel referansları önler
    ...
    // Projeye birden fazla kullanıcı eklenebilir.
    // Bu kullanıcılar projeye katkıda bulunabilir.
    }
