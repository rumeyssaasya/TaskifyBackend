...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@RequestBody User user) {
        ...
        if ("MALE".equalsIgnoreCase(gender)) {
            user.setProfileImageUrl("/images/default_male.png");
        } else if ("FEMALE".equalsIgnoreCase(gender)) {
            user.setProfileImageUrl("/images/default_female.png");
        } else {
        user.setProfileImageUrl("/images/default.png"); // Genel default, boş bırakma
}
